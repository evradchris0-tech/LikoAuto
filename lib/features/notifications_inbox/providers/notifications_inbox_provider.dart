...
/// Sème la table avec 8 entries au premier appel si vide.
final notificationsInboxProvider =
  ...
  final q = db.select(db.notifications)
    ..orderBy([
...
class NotificationsActions {
  ...
  Future<void> push(AppNotification n) async {
    await _db
        ...
        .insertOnConflictUpdate(_toCompanion(n));
  }
}

final notificationsActionsProvider = Provider<NotificationsActions>((ref) {
  return NotificationsActions(ref.watch(appDatabaseProvider));
});
