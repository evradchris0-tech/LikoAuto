...
class BookingsActions {
  BookingsActions(this._db);
...
final bookingsActionsProvider = Provider<BookingsActions>((ref) {
  return BookingsActions(ref.watch(appDatabaseProvider));
});
